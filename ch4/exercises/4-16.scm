...
;; Answer c.
;; The scan-out-defines works well either in make-procedure
;; or procedure-body
;; but when in make-procedure, it is called only once but
;; when in procedure-body, it could be called many times.
;; So it should be in make-procedure for efficiency.

;; TEST for changing insert it in make-procedure
(define (make-procedure parameters body env)
  (list 'procedure parameters (scan-out-defines body) env))

;; ;;; M-Eval input:
;; (define (y) (define x 3) (cons x 2))
;; ;;; M-Eval value:
;; ok
;; ;;; M-Eval input:
;; y
;; ;;; M-Eval value:
;; (compound-procedure () ((let ((x (quote *unassigned*))) (set! x 3) (cons x 2))) <procedure-env>)
;; ;;; M-Eval input:
;; (y)
;; ;;; M-Eval value:
;; (3 . 2)
...
;; TEST for changing insert it in procedure-body
