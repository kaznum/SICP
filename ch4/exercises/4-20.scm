...
(define (letrec-variables clauses) (map car clauses))
(define (letrec-operations clauses) (map cadr clauses))
(define (letrec-body exp) (cddr exp))

(define (letrec->let exp)
  (append (list 'let (map (lambda (k) (list k ''*unassigned*))
			  (letrec-variables (letrec-clauses exp))))
	  (map (lambda (k-v) (cons 'set! k-v)) (letrec-clauses exp))
	  (let-body exp)))
