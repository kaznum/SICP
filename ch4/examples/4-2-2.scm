...
;; 'list-of-arg-values' and 'list-of-delayed-args' is the
;; modified version of 4.1.1's 'list-of-values'
...
;;;; TEST
;;;; the following code does not work because there is no definition of force-it and delay-it
