...
;; The above is (1458/169) * ( x^2 - 2x + 1)
;; The second remainder is () means 0
;; So the polynomial gcd is x^2 - 2x + 1
;; But the implementation use the rational number to fit coefficients,
;; so the result has some difficult coefficients.
